                ...
                <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input id="remember_me" type="checkbox" wire:model="remember"
                            class="w-4 h-4 border border-gray-300 rounded-sm bg-gray-50 focus:ring-1 focus:ring-blue-300 accent-blue-500 dark:bg-slate-600 dark:border-slate-500 transition-colors duration-500 ease-in-out" />
                    </div>
                    <label for="remember_me" class="ms-2 text-sm font-medium dark:text-slate-100 transition-colors duration-500 ease-in-out">Ingat saya</label>
                </div>
