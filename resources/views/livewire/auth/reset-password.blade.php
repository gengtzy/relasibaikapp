<div class="flex justify-center items-center min-h-screen">
    <div class="w-full max-w-sm px-6 pb-6 bg-white border border-white rounded-lg shadow-lg">
        ...
        <h5 class="text-2xl font-bold text-gray-900 pt-6 mb-6">Buat Kata Sandi Baru</h5>
        ...
        <form wire:submit="resetPassword" class="space-y-6">
            ...
            <div>
                ...
                <input wire:model="email" id="email" type="email" required readonly
                    class="bg-gray-100 border border-gray-300 text-gray-500 text-base rounded-lg block w-full p-2.5 cursor-not-allowed" />
