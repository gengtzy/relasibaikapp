    ...
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 px-4 sm:px-0">
                    ...
                    <form wire:submit="updateProfile" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input wire:model="name" id="name" type="text"
                                class="w-full border-slate-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors p-2.5">
                            @error('name')
                        ...
                        {{-- Email --}}
                        <div>
                            <label for="email" class="block text-sm font-semibold text-slate-700 mb-1">Alamat
                                Email</label>
                            <input wire:model="email" id="email" type="email"
                                class="w-full border-slate-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500  p-2.5">
                            @error('email')
                                <span class="text-red-500 text-xs mt-1 font-medium">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            <label for="role_display" class="block text-sm font-semibold text-slate-700 mb-1">
                                Peran Superior
                            </label>
                            <div class="relative">
                                {{-- Input Disabled --}}
                                <input type="text" value="{{ $superiority_role }}" disabled
                                    class="w-full border-slate-200 bg-slate-100 text-slate-500 rounded-lg shadow-sm cursor-not-allowed focus:ring-0 p-2.5">
            ...
            <div class="lg:col-span-1">
                <div class="p-6 bg-white shadow-sm sm:rounded-xl border border-slate-200">
                    ...
                    <form wire:submit="updatePassword" class="space-y-8">
                        ...
                        <div>
                            <label for="current_password"
                                class="block text-xs font-bold text-slate-600 uppercase tracking-wider mb-1">Password
                                Lama</label>
                            <input wire:model="current_password" id="current_password" type="password"
                                class="w-full border-slate-300 rounded-lg shadow-sm focus:border-slate-800 focus:ring-slate-800 text-sm p-2.5">
                        ...
                        <div>
                            <label for="password_confirmation"
                                class="block text-xs font-bold text-slate-600 uppercase tracking-wider mb-1">Konfirmasi
                                Baru</label>
