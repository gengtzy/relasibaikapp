    ...
    <form wire:submit="save">
        <section id="form" class="flex justify-center items-center h-screen py-24">
            <div
                ...
                <div class="space-y-6">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-slate-800">Isi dulu dengan benar ya 😊</h5>
                    <p class="mb-3 font-normal text-gray-700">Lengkapi formulir pengisian dibawah ini.</p>

                    <div class="mt-6">
                        <label for="lokasi" class="block mb-2 text-lg font-medium text-gray-900">Lokasi
                            Pengisian</label>
                        <input wire:model="lokasi" type="text" id="lokasi"
