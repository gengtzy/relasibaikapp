                ...
                @if ($isFinished)
                    <div>
                        ...
                        <button wire:click="goToResult"
                            class="w-full inline-flex justify-center items-center px-5 py-3 text-base font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 transition-all shadow-lg">
                            Cek Hasil
                            <svg class="w-4 h-4 ml-2 rtl:rotate-180" aria-hidden="true"
