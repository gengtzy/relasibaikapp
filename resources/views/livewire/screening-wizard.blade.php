            ...
            <div
                ...
                @if ($isProcessing)
                    <div class="animate-pulse">
                        <h3 class="text-xl font-bold text-gray-800 mb-2 dark:text-slate-50 transition-colors duration-500 ease-in-out">Tunggu sebentar yaa...</h3>
                        <p class="text-gray-500 mb-6 dark:text-slate-100 transition-colors duration-500 ease-in-out">Sistem sedang menghitung hasil skrining kamu 🧐</p>
