<div>
    ...
    <div class="flex items-start justify-between">
        ...
        <button wire:click="delete" wire:confirm="Anda yakin ingin menghapus '{{ $name }}'?" type="button"
        ...
        <div class="rounded-2xl mb-6 shadow-sm border border-gray-200 bg-white p-5">
            <div class="grid grid-cols-2 gap-12">
                ...
                <div>
                    {{-- Input Password --}}
                    <div class="mb-6">
                        <label for="password" class="block mb-2 font-semibold text-base text-gray-900">Password Baru
                            (Opsional)</label>
                    ...
                    <div class="mb-6">
                        <label for="password_confirmation"
                            class="block mb-2 font-semibold text-base text-gray-900">Konfirmasi Password</label>
                    ...
                    {{-- Input Peran --}}
                    <div class="">
                        <label for="role" class="block mb-2 font-semibold text-base text-gray-900">Peran</label>
