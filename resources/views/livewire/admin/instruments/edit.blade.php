<div x-data="{ showModal: @entangle('showModal') }" x-init="$watch('showModal', value => {
    ...
    <div class="flex items-start justify-between">
        ...
        {{-- UPDATE TOMBOL HAPUS: Panggil Modal --}}
            ...
            <div class="relative bg-white border border-gray-200 rounded-xl shadow-2xl p-4 md:p-6">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <div class="mb-4 p-3 bg-red-50 text-red-700 text-sm rounded-lg text-left">
                        <strong>PERHATIAN:</strong> Menghapus instrumen juga akan <strong>MENGHAPUS SEMUA
                            PERTANYAAN</strong> yang terkait di dalamnya secara permanen.
                    </div>

                    {{-- Detail Nama Instrumen --}}
