            ...
            @if(count($selectedRecommendations) > 0)
                <div class="w-full md:w-auto">
                    <button 
                        @click="
                            isBulk = true;
                            bulkCount = {{ count($selectedRecommendations) }};
                            showModal = true;
                            ...
                            <td class="flex gap-2 px-6 py-4">
                                ...
                                <button type="button"
                                    @click="
                                        isBulk = false;
                                        showModal = true; 
                                        deleteId = {{ $recommendation->id }}; 
                                        deleteCode = '{{ Str::limit($recommendation->title, 30) }}'; 
                                        $wire.set('deleteId', {{ $recommendation->id }}, false);
                ...
                <div class="relative bg-white border border-gray-200 rounded-xl shadow-2xl p-4 md:p-6">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-2 text-lg font-normal text-gray-500">
                            {{-- Judul Dinamis --}}
                            <span x-text="isBulk ? 'Hapus ' + bulkCount + ' rekomendasi terpilih?' : 'Hapus Rekomendasi ini?'"></span>
                        </h3>

                        {{-- Teks Judul Rekomendasi --}}
